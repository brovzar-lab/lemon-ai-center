  ...
  return (
    <header className="sticky top-0 z-40 bg-bg-base/90 backdrop-blur-sm border-b border-border-soft px-6 py-2.5 flex items-center justify-between" role="banner">
      <div className="flex items-center gap-3">
        <span className="text-[11px] font-body font-bold uppercase tracking-[0.2em] text-text-primary">
          Lemon Studios
        </span>
        <span className="text-[11px] font-body uppercase tracking-[0.2em] text-text-muted">
          Command
        </span>
      </div>
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="text-[11px] font-body font-semibold text-text-secondary hover:text-text-primary transition-colors px-3 py-1.5 rounded-md border border-border-soft hover:border-border-medium disabled:opacity-40 min-h-[36px] flex items-center gap-1.5"
